...
var _BrowserDetect = __webpack_require__(64);

var _BrowserDetect2 = _interopRequireDefault(_BrowserDetect);

var _Compatibility = __webpack_require__(65);

var _Compatibility2 = _interopRequireDefault(_Compatibility);

var _gsap = __webpack_require__(66);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.Vue = _vue2.default;
window.BrowserDetect = _BrowserDetect2.default;
window.BrowserDetect.Compatibility = _Compatibility2.default;
...
__matchMedia = function __matchMedia(context) {
...
exports.default = window.BrowserDetect;
...
var Compatibility = function () {
  ...
  _createClass(Compatibility, [{
    key: "IECompatible",
    value: function IECompatible(version) {
      var ver = this.getInternetExplorerVersion;
      if (ver > -1) {
        if (ver >= version) return true;else return false;
      }
...
exports.default = _compatibility;
				...
				this.check = function(init) {
					...
					if (missing === 0 && func) {
						...
						if (global) {
							...
							if (!hasModule && "function" === "function" && __webpack_require__(175)){ //AMD
